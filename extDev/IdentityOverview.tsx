...
import { CredsDetailView } from './components/CredsDetailView';
import { getIdentities, createIdentity, updateIdentity, deleteIdentity, getCredentialGroups, createCredentialGroup, updateCredentialGroup, deleteCredentialGroup } from './db';
  ...
  return (
    <div className="flex h-screen w-full bg-background font-sans text-gray-200 overflow-hidden selection:bg-techCyan selection:text-black">
      ...
      <div className="w-80 flex-shrink-0 flex flex-col border-r border-white/5 bg-surface z-20 shadow-[5px_0_20px_rgba(0,0,0,0.5)]">
        ...
        {/* Sidebar Header */}
        <div className="h-16 flex items-center px-6 border-b border-white/5 bg-surfaceHighlight/20 backdrop-blur-sm sticky top-0">
          <div className="mr-3 text-techCyan animate-pulse">
            <Hexagon size={28} />
          </div>
          <span className="font-bold text-xl tracking-[0.2em] text-white">ORION</span>
          <div className="ml-auto text-[10px] px-1.5 py-0.5 bg-techCyan/10 border border-techCyan/30 text-techCyan font-mono">V.1.0</div>
        </div>
        ...
        {/* User Footer */}
        <div className="p-4 border-t border-white/5 bg-surfaceHighlight/10 flex items-center gap-3">
          <div className="w-8 h-8 bg-techCyan/20 flex items-center justify-center border border-techCyan/30 text-techCyan font-bold text-xs">
            OP
          </div>
          <div className="flex-1">
            <div className="text-xs font-bold text-white uppercase tracking-wider">OPERATOR</div>
            <div className="text-[10px] text-techCyan font-mono">SYS_ADMIN_ROOT</div>
          </div>
