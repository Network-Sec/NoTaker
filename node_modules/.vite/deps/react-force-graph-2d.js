import {
  debounce_default,
  throttle_default
} from "./chunk-ATSPSPX7.js";
import {
  require_react
} from "./chunk-FDI32NCY.js";
import {
  __commonJS,
  __toESM
...
function bindIndex(parent, group2, enter, update4, exit, data) {
...
function bindKey(parent, group2, enter, update4, exit, data, key) {
...
function data_default(value, key) {
  ...
  for (var m3 = groups2.length, update4 = new Array(m3), enter = new Array(m3), exit = new Array(m3), j2 = 0; j2 < m3; ++j2) {
    var parent = parents[j2], group2 = groups2[j2], groupLength = group2.length, data = arraylike(value.call(parent, parent && parent.__data__, j2, parents)), dataLength = data.length, enterGroup = enter[j2] = new Array(dataLength), updateGroup = update4[j2] = new Array(dataLength), exitGroup = exit[j2] = new Array(groupLength);
...
function basis_default(values) {
  ...
  return function(t5) {
    var i2 = t5 <= 0 ? t5 = 0 : t5 >= 1 ? (t5 = 1, n2 - 1) : Math.floor(t5 * n2), v1 = values[i2], v2 = values[i2 + 1], v0 = i2 > 0 ? values[i2 - 1] : 2 * v1 - v2, v3 = i2 < n2 - 1 ? values[i2 + 2] : 2 * v2 - v1;
...
function basisClosed_default(values) {
  ...
  return function(t5) {
    var i2 = Math.floor(((t5 %= 1) < 0 ? ++t5 : t5) * n2), v0 = values[(i2 + n2 - 1) % n2], v1 = values[i2 % n2], v2 = values[(i2 + 1) % n2], v3 = values[(i2 + 2) % n2];
    return basis((t5 - i2 / n2) * n2, v0, v1, v2, v3);
  };
}
...
function zoom_default2() {
  ...
  zoom2.filter = function(_2) {
    return arguments.length ? (filter3 = typeof _2 === "function" ? _2 : constant_default4(!!_2), zoom2) : filter3;
  };
...
function blurf(radius) {
  ...
  return (T2, S2, start2, stop, step) => {
    ...
    for (let i2 = start2, j2 = stop; i2 <= j2; i2 += step) {
      ...
      T2[i2] = (sum2 + t5 * (S2[Math.max(start2, i2 - s1)] + S2[Math.min(stop, i2 + s1)])) / w2;
      sum2 -= S2[Math.max(start2, i2 - s0)];
    }
  };
}
...
function max(values, valueof) {
  ...
  if (valueof === void 0) {
    ...
    for (let value of values) {
      if ((value = valueof(value, ++index8, values)) != null && (max3 < value || max3 === void 0 && value >= value)) {
        max3 = value;
      }
    }
  }
...
function min(values, valueof) {
  ...
  if (valueof === void 0) {
    ...
    let index8 = -1;
    for (let value of values) {
      if ((value = valueof(value, ++index8, values)) != null && (min3 > value || min3 === void 0 && value >= value)) {
        min3 = value;
      }
    }
  }
...
function shuffler(random) {
  return function shuffle(array3, i0 = 0, i1 = array3.length) {
    let m3 = i1 - (i0 = +i0);
    while (m3) {
      const i2 = random() * m3-- | 0, t5 = array3[m3 + i0];
...
function sum(values, valueof) {
  ...
  if (valueof === void 0) {
    ...
    let index8 = -1;
    for (let value of values) {
      if (value = +valueof(value, ++index8, values)) {
        sum2 += value;
      }
    }
  }
...
function cover_default3(x3, y3, z3) {
  ...
  if (isNaN(x0)) {
    ...
    var t5 = x1 - x0 || 1, node = this._root, parent, i2;
    while (x0 > x3 || x3 >= x1 || y0 > y3 || y3 >= y1 || z0 > z3 || z3 >= z1) {
      i2 = (z3 < z0) << 2 | (y3 < y0) << 1 | x3 < x0;
      parent = new Array(8), parent[i2] = node, node = parent, t5 *= 2;
      switch (i2) {
        case 0:
...
function link_default(links) {
  var id2 = index6, strength = defaultStrength, strengths, distance2 = constant_default5(30), distances, nodes, nDim, count2, bias, random, iterations = 1;
  if (links == null) links = [];
...
var utils = {
  ...
  length: function(derivativeFn) {
    ...
    for (let i2 = 0, t5; i2 < len; i2++) {
      ...
      sum2 += utils.Cvalues[i2] * utils.arcfn(t5, derivativeFn);
    }
    return z3 * sum2;
  },
...
var Bezier = class _Bezier {
  ...
  split(t13, t22) {
    ...
    result.left._t2 = utils.map(t13, 0, 1, this._t1, this._t2);
    result.right._t1 = utils.map(t13, 0, 1, this._t1, this._t2);
  ...
  extrema() {
    ...
    this.dims.forEach(
      (function(dim) {
        ...
        result[dim] = result[dim].filter(function(t5) {
          return t5 >= 0 && t5 <= 1;
        });
...
function ordinal() {
  var index8 = new InternMap(), domain = [], range2 = [], unknown = implicit;
  function scale(d2) {
